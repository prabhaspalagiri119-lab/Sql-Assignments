...
-- -- SELECT UPPER('data science') FROM dual;
-- -- SELECT LOWER('ARTIFICIAL INTELLIGENCE') FROM dual;
-- -- SELECT INITCAP('data base oracle') FROM dual;
...
-- -- SELECT REPLACE('hello oracle', 'oracle', 'python') FROM dual;
...
-- -- SELECT INITCAP('oracle database adminstrator') FROM dual;
-- -- SELECT LENGTH('machine learning') FROM dual;
-- -- SELECT SUBSTR('artificial intelligence', 1,10) FROM dual;
-- -- SELECT CONCAT('Oracle ', 'SQL') FROM dual;
...
-- -- SELECT CEIL(28.01) FROM dual;
-- -- SELECT FLOOR(27.99) FROM dual;
-- -- SELECT MOD(26,4) FROM dual;
-- -- SELECT ABS(-999.50) FROM dual;
